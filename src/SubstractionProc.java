...
System.out.println("The result of SubstractionProc is "+result.the_value);
      } catch (Exception ex) {
System.out.println("SubstractionProc - Problems while executing procedure");
      }
   }
}
