...
/**
* org/omg/WorkflowModel/WfRequesterPOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 WorkflowModel.idl
* 2009年2月3日 星期二 下午05时32分28秒 CST
*/

public abstract class WfRequesterPOA extends org.omg.PortableServer.Servant
 implements org.omg.WorkflowModel.WfRequesterOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public WfRequester _this() 
  {
    return WfRequesterHelper.narrow(
    super._this_object());
  }

  public WfRequester _this(org.omg.CORBA.ORB orb) 
  {
    return WfRequesterHelper.narrow(
