...
/**
* org/omg/WorkflowModel/WfStateEventAuditPOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 WorkflowModel.idl
* 2009年2月3日 星期二 下午05时32分28秒 CST
*/

public abstract class WfStateEventAuditPOA extends org.omg.PortableServer.Servant
 implements org.omg.WorkflowModel.WfStateEventAuditOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("old_state", new java.lang.Integer (0));
    _methods.put ("new_state", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // WorkflowModel/WfStateEventAudit/old_state
       {
         try {
           String $result = null;
           $result = this.old_state ();
           out = $rh.createReply();
       ...
       case 1:  // WorkflowModel/WfStateEventAudit/new_state
       {
         try {
           String $result = null;
           $result = this.new_state ();
           out = $rh.createReply();
           out.write_wstring ($result);
         } catch (org.omg.WfBase.BaseException $ex) {
           out = $rh.createExceptionReply ();
  ...
  private static String[] __ids = {
    "IDL:omg.org/WorkflowModel/WfStateEventAudit:1.0", 
  ...
  public WfStateEventAudit _this() 
  {
    return WfStateEventAuditHelper.narrow(
    super._this_object());
  }

  public WfStateEventAudit _this(org.omg.CORBA.ORB orb) 
  {
    return WfStateEventAuditHelper.narrow(
