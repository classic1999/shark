...
import org.enhydra.shark.swingclient.workflowadmin.report.*;
...
import org.enhydra.shark.swingclient.workflowadmin.cache.*;
...
public class SharkAdmin extends SharkClient {
   ...
   public static void main(String[] args) throws Exception {
      // Checks if java version is >= 1.4.1
      ...
      if (args!=null && args.length>1) {
         sa.deadlineCheckingTime=Long.parseLong(args[1]);
      }

      // initialize limit timer
      String ldelay=null;
      if (args!=null && args.length>2) {
         sa.limitCheckingTime=Long.parseLong(args[2]);
      }
   }
