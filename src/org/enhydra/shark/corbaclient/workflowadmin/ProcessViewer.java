         ...
         for (int i=0; i<allRunningActs.length; i++) {
            ...
            try {
               ...
               if (blockId!=null && blockId.trim().length()>0) {
                ...
                System.err.println("displayProcess blockId: "+ex);
            }
            ...
            try {
               ...
               if (go!=null) {
                ...
                System.err.println("displayProcess Activity: "+ex);
            }
         }
         //System.out.println("Selection refreshed");
      } catch (Exception ex) {
         System.err.println("display Process: Problems while updating selection: "+ex);
         // ex.printStackTrace();
      }
   }
