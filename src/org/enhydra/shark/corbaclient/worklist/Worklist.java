...
import org.enhydra.shark.corbaclient.worklist.actions.*;
...
public class Worklist extends ActionPanel {
    ...
    */
   public NameValue[] getWorkitemContext (String workitemKey) {
      return (NameValue[])procVariables.get(workitemKey);
   }

   /**
    * Adds mapping of workitem key to it's context.
    */
   public void putWorkitemContext (String workitemKey,NameValue[] context) {
