...
public class NTVDPanel extends ActionPanel {
   ...
   public NTVDPanel(NameValue nv,String nm,String d,String typeKey,boolean isReadOnly) {
      super();
      this.nameValue=nv;
      this.varName=nm;
      this.desc=d;
   ...
   protected Component createCenterComponent () {
      ...
      if (varName!=null && varName.trim().length()>0) {
         ...
         name.setText(nameValue.the_name);
      }
      ...
      try {
         val=WorkflowUtilities.exstractValueOfAnyObject(nameValue.the_value,typeKey);
      } catch (Exception ex) {}
      ...
      description.addActionListener(new ActionListener () {
               public void actionPerformed (ActionEvent ae) {
                  ...
                  ItemView iv=new ItemView(getWindow(),
                                           dk+" - "+((varName==null || varName.trim().length()==0)?nameValue.the_name:varName),dk,desc);
                  iv.showDialog();
               }
            });
   ...
   public boolean updateField () {
      ...
      if (value!=null) {
         Any a=WorkflowUtilities.insertValueIntoAnyObject(
            nameValue.the_value,value.getText(),typeKey);
         if (a!=null) {
            updated=true;
            nameValue.the_value=a;
         }
      } else if (choices!=null) {
         Any a=WorkflowUtilities.insertValueIntoAnyObject(
            nameValue.the_value,choices.getSelectedItem().toString(),typeKey);
         if (a!=null) {
            updated=true;
            nameValue.the_value=a;
         }
         ...
         Any a=WorkflowUtilities.insertValueIntoAnyObject(
            nameValue.the_value,dte,typeKey);
         if (a!=null) {
            updated=true;
            nameValue.the_value=a;
         }
