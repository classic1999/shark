 ...
 * @version 1.0
 */
public class WfActivityCORBA extends _WfActivityImplBase {
    ...
    * 
    * @throws org.omg.WfBase.BaseException General workflow exception.
   ...
   public WfProcess container() throws BaseException {
      try {
         return new WfProcessCORBA(__collective, sharkAct.container());
      } catch (Exception ex) {
         throw new BaseException();
      }
   }
   ...
   public WfEventAuditIterator get_iterator_history(String query,
                                                    NameValue[] names_in_query) throws BaseException,
                                                                               HistoryNotAvailable {
      try {
         return new WfEventAuditIteratorCORBA(__collective,
