...
import org.omg.WorkflowModel._WfProcessIteratorImplBase;
 ...
 * @version 1.0
 */
public class WfProcessIteratorCORBA extends _WfProcessIteratorImplBase {

   org.enhydra.shark.api.client.wfmodel.WfProcessIterator myIterator;

   private Collective __collective;

   protected WfProcessIteratorCORBA(Collective toJoin,
   ...
   public WfProcess get_next_object() throws BaseException {
      try {
         return new WfProcessCORBA(__collective, myIterator.get_next_object());
      } catch (Exception ex) {
         throw new BaseException();
      }
   }
