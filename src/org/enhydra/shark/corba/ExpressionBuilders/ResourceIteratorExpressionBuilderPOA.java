...
/**
* org/enhydra/shark/corba/ExpressionBuilders/ResourceIteratorExpressionBuilderPOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 ExpressionBuilders.idl
* 2009年2月3日 星期二 下午05时32分30秒 CST
*/

public abstract class ResourceIteratorExpressionBuilderPOA extends org.omg.PortableServer.Servant
 implements org.enhydra.shark.corba.ExpressionBuilders.ResourceIteratorExpressionBuilderOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public ResourceIteratorExpressionBuilder _this() 
  {
    return ResourceIteratorExpressionBuilderHelper.narrow(
    super._this_object());
  }

  public ResourceIteratorExpressionBuilder _this(org.omg.CORBA.ORB orb) 
  {
    return ResourceIteratorExpressionBuilderHelper.narrow(
...
} // class ResourceIteratorExpressionBuilderPOA
