...
/**
* org/enhydra/shark/corba/ExpressionBuilders/AssignmentIteratorExpressionBuilderPOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 ExpressionBuilders.idl
* 2009年2月3日 星期二 下午05时32分30秒 CST
*/

public abstract class AssignmentIteratorExpressionBuilderPOA extends org.omg.PortableServer.Servant
 implements org.enhydra.shark.corba.ExpressionBuilders.AssignmentIteratorExpressionBuilderOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public AssignmentIteratorExpressionBuilder _this() 
  {
    return AssignmentIteratorExpressionBuilderHelper.narrow(
    super._this_object());
  }

  public AssignmentIteratorExpressionBuilder _this(org.omg.CORBA.ORB orb) 
  {
    return AssignmentIteratorExpressionBuilderHelper.narrow(
...
} // class AssignmentIteratorExpressionBuilderPOA
