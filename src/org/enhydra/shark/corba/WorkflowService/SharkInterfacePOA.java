...
/**
* org/enhydra/shark/corba/WorkflowService/SharkInterfacePOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 WorkflowService.idl
* 2009年2月3日 星期二 下午05时32分32秒 CST
*/

public abstract class SharkInterfacePOA extends org.omg.PortableServer.Servant
 implements org.enhydra.shark.corba.WorkflowService.SharkInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public SharkInterface _this() 
  {
    return SharkInterfaceHelper.narrow(
    super._this_object());
  }

  public SharkInterface _this(org.omg.CORBA.ORB orb) 
  {
    return SharkInterfaceHelper.narrow(
