...
/**
* org/enhydra/shark/corba/WorkflowService/LimitAdministrationPOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 WorkflowService.idl
* 2009年2月3日 星期二 下午05时32分31秒 CST
*/

public abstract class LimitAdministrationPOA extends org.omg.PortableServer.Servant
 implements org.enhydra.shark.corba.WorkflowService.LimitAdministrationOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public LimitAdministration _this() 
  {
    return LimitAdministrationHelper.narrow(
    super._this_object());
  }

  public LimitAdministration _this(org.omg.CORBA.ORB orb) 
  {
    return LimitAdministrationHelper.narrow(
