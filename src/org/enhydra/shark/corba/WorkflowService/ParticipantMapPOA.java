...
/**
* org/enhydra/shark/corba/WorkflowService/ParticipantMapPOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 WorkflowService.idl
* 2009年2月3日 星期二 下午05时32分31秒 CST
*/

public abstract class ParticipantMapPOA extends org.omg.PortableServer.Servant
 implements org.enhydra.shark.corba.WorkflowService.ParticipantMapOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  public ParticipantMap _this() 
  {
    return ParticipantMapHelper.narrow(
    super._this_object());
  }

  public ParticipantMap _this(org.omg.CORBA.ORB orb) 
  {
    return ParticipantMapHelper.narrow(
