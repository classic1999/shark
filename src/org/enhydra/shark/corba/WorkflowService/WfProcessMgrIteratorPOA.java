...
/**
* org/enhydra/shark/corba/WorkflowService/WfProcessMgrIteratorPOA.java .
* 由 IDL-to-Java 编译器（可移植），版本 "3.2" 生成
* 来自 WorkflowService.idl
* 2009年2月3日 星期二 下午05时32分32秒 CST
*/

public abstract class WfProcessMgrIteratorPOA extends org.omg.PortableServer.Servant
 implements org.enhydra.shark.corba.WorkflowService.WfProcessMgrIteratorOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // WorkflowService/WfProcessMgrIterator/get_next_object
       {
         try {
       ...
       case 1:  // WorkflowService/WfProcessMgrIterator/get_previous_object
       {
         try {
           org.omg.WorkflowModel.WfProcessMgr $result = null;
       ...
       case 2:  // WorkflowService/WfProcessMgrIterator/get_next_n_sequence
       {
         try {
       ...
       case 3:  // WorkflowService/WfProcessMgrIterator/get_previous_n_sequence
       {
         try {
           int max_number = in.read_long ();
           org.omg.WorkflowModel.WfProcessMgr $result[] = null;
  ...
  private static String[] __ids = {
    "IDL:WorkflowService/WfProcessMgrIterator:1.0", 
  ...
  public WfProcessMgrIterator _this() 
  {
    return WfProcessMgrIteratorHelper.narrow(
    super._this_object());
  }

  public WfProcessMgrIterator _this(org.omg.CORBA.ORB orb) 
  {
    return WfProcessMgrIteratorHelper.narrow(
