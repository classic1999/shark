...
/**
* org/enhydra/shark/corba/WorkflowService/ByteSequenceHelper.java .
...
{
  private static String  _id = "IDL:WorkflowService/ByteSequence:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (org.enhydra.shark.corba.WorkflowService.ByteSequenceHelper.id (), "ByteSequence", __typeCode);
    }
    return __typeCode;
  }
