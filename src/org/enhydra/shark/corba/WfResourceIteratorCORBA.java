...
import org.enhydra.shark.corba.WorkflowService._WfResourceIteratorImplBase;
 ...
 * @version 1.0
 */
public class WfResourceIteratorCORBA extends _WfResourceIteratorImplBase /*implements
Collective.Member */ {
   ...
   public WfResource get_next_object() throws BaseException {
      try {
         return new WfResourceCORBA(__collective,
