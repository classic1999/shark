 ...
 * @version 1.0
 */
public class WfProcessCORBA extends WfProcessPOA {
     ...
     */
    protected WfProcessCORBA(ORB orb, Collective toJoin,
                             org.enhydra.shark.api.client.wfmodel.WfProcess sharkProc) {
  ...
  //      toJoin.__recruit(this);
    ...
    public WfRequester requester() throws BaseException {
        try {
            ...
            if (requester instanceof org.enhydra.shark.api.client.wfmodel.WfActivity) {
                req = SharkCORBAUtilities.makeWfActivity(new WfActivityCORBA(orb, __collective,
                ...
                req = SharkCORBAUtilities.makeWfRequester(new WfRequesterCORBA(orb , __collective, requester));
            }
            __collective.__recruit(req);
            return req;
        } catch (Exception ex) {
    ...
    public void set_requester(WfRequester new_value) throws BaseException,
        ...
        if (new_value instanceof WfActivity) {
            throw new CannotChangeRequester("Can't change requester to activity requester");
        }
    ...
    public WfActivityIterator get_iterator_step() throws BaseException {
        try {
            WfActivityIterator iter = SharkCORBAUtilities.makeWfActivityIterator(new WfActivityIteratorCORBA(orb, __collective,
    ...
    public WfProcessMgr manager() throws BaseException {
        ...
        try {
            ret = SharkCORBAUtilities.makeWfProcessMgr(new WfProcessMgrCORBA(orb, __collective, sharkProc.manager()) );
        } catch (org.enhydra.shark.api.client.wfbase.BaseException e) {
            e.printStackTrace();
            throw new BaseException();
        }
        __collective.__recruit(ret);
        return ret;
    }
    ...
    public WfEventAuditIterator get_iterator_history(String query,
        ...
        try {
            ret = SharkCORBAUtilities.makeWfEventAuditIterator(new WfEventAuditIteratorCORBA(orb, __collective, sharkProc.get_iterator_history(query,
