...
public class MappingAdminCORBA extends MappingAdministrationPOA implements Collective {
   ...
   public ParticipantMap createParticipantMap() throws BaseException,
                                               NotConnected {
      if (!connected) { throw new NotConnected("The connection is not established..."); }
      ParticipantMapCORBA impl = new ParticipantMapCORBA();
       ParticipantMap ret = null;
       try {
            myServer._poa().activate_object(impl);
            ret = ParticipantMapHelper.narrow(myServer._poa().servant_to_reference(impl));
   ...
   public ApplicationMap[] getAllApplications() throws BaseException,
      ...
      if (!connected) { throw new NotConnected("The connection is not established..."); }
      try {
         return SharkCORBAUtilities.makeCORBAApplicationMaps(myServer._orb(), this,
