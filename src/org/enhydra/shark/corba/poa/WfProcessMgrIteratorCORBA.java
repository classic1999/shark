...
import org.enhydra.shark.corba.WorkflowService.WfProcessMgrIteratorPOA;
import org.enhydra.shark.corba.poa.Collective;
import org.enhydra.shark.corba.poa.SharkCORBAUtilities;
import org.enhydra.shark.corba.poa.WfProcessMgrCORBA;
 ...
 * @version 1.0
 */
public class WfProcessMgrIteratorCORBA extends WfProcessMgrIteratorPOA {
   ...
   protected WfProcessMgrIteratorCORBA(ORB orb, Collective toJoin,
   ...
   public WfProcessMgr get_next_object() throws BaseException {
      try {
          WfProcessMgr proc = SharkCORBAUtilities.makeWfProcessMgr(  new WfProcessMgrCORBA(orb,  __collective, myIterator.get_next_object()));
   ...
   public WfProcessMgr get_previous_object() throws BaseException {
      try {
         WfProcessMgr proc = SharkCORBAUtilities.makeWfProcessMgr( new WfProcessMgrCORBA(orb, __collective,
   ...
   public WfProcessMgr[] get_next_n_sequence(int max_number) throws BaseException {
      try {
         return SharkCORBAUtilities.makeCORBAProcessMgrs(orb, __collective,
