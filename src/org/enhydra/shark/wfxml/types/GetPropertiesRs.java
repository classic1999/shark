...
public class GetPropertiesRs  implements java.io.Serializable {
    ...
    private org.enhydra.shark.wfxml.types.RegistryPropertiesGroup registryPropertiesGroup;
    ...
    public GetPropertiesRs(
           ...
           org.enhydra.shark.wfxml.types.RegistryPropertiesGroup registryPropertiesGroup) {
           ...
           this.registryPropertiesGroup = registryPropertiesGroup;
    }


    /**
     * Gets the instancePropertiesGroup value for this GetPropertiesRs.
     * 
    ...
    /**
     * Sets the instancePropertiesGroup value for this GetPropertiesRs.
     * 
    ...
    /**
     * Gets the factoryPropertiesGroup value for this GetPropertiesRs.
     * 
    ...
    /**
     * Sets the factoryPropertiesGroup value for this GetPropertiesRs.
     * 
    ...
    /**
     * Gets the observerPropertiesGroup value for this GetPropertiesRs.
     * 
    ...
    /**
     * Sets the observerPropertiesGroup value for this GetPropertiesRs.
     * 
    ...
    /**
     * Gets the registryPropertiesGroup value for this GetPropertiesRs.
     * 
     * @return registryPropertiesGroup
     */
    public org.enhydra.shark.wfxml.types.RegistryPropertiesGroup getRegistryPropertiesGroup() {
        return registryPropertiesGroup;
    }


    /**
     * Sets the registryPropertiesGroup value for this GetPropertiesRs.
     * 
     * @param registryPropertiesGroup
     */
    public void setRegistryPropertiesGroup(org.enhydra.shark.wfxml.types.RegistryPropertiesGroup registryPropertiesGroup) {
        this.registryPropertiesGroup = registryPropertiesGroup;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetPropertiesRs)) return false;
        GetPropertiesRs other = (GetPropertiesRs) obj;
        ...
        _equals = true && 
            ...
            ((this.registryPropertiesGroup==null && other.getRegistryPropertiesGroup()==null) || 
             (this.registryPropertiesGroup!=null &&
              this.registryPropertiesGroup.equals(other.getRegistryPropertiesGroup())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getRegistryPropertiesGroup() != null) {
            _hashCode += getRegistryPropertiesGroup().hashCode();
        }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetPropertiesRs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.wfmc.org/wfxml/2.0/", ">GetPropertiesRs"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("registryPropertiesGroup");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.wfmc.org/wfxml/2.0/", "registryPropertiesGroup"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.wfmc.org/wfxml/2.0/", "registryPropertiesGroup"));
        typeDesc.addFieldDesc(elemField);
    }
