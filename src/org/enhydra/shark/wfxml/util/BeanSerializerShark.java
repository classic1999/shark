 ...
 */
public class BeanSerializerShark implements Serializer, Serializable {

    protected static Log log =
        LogFactory.getLog(BeanSerializerShark.class.getName());
    ...
    public BeanSerializerShark(Class javaType, QName xmlType) {
        this(javaType, xmlType, TypeDesc.getTypeDescForClass(javaType));
    }

    // Construct BeanSerializer for the indicated class/qname
    public BeanSerializerShark(Class javaType, QName xmlType, TypeDesc typeDesc) {
    ...
    private boolean isEmptyObjectType(QName name) {
       return (name.getLocalPart().equals("GetPropertiesRq"))
       || (name.getLocalPart().equals("SubscribeRs"))
       || (name.getLocalPart().equals("UnsubscribeRs"))
       || (name.getLocalPart().equals("CompletedRs"))
       || (name.getLocalPart().equals("StateChangedRs"));
    }
    /**
