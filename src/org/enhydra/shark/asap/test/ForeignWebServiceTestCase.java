...
/*
   public void test6asapObserverBindingGetProperties() throws Exception {
      ...
      try {
         binding = (AsapObserverBindingStub) new SharkWebServiceLocator()
      ...
      _Request rqh = new _Request();
      Object rqb = new java.lang.String();
   ...
   public void test7asapObserverBindingCompleted() throws Exception {
      ...
      _Request rqh = new _Request();
      _CompletedRq rqb = new _CompletedRq();
      _ResponseHolder rsh = new _ResponseHolder();
      ObjectHolder rsb = new javax.xml.rpc.holders.ObjectHolder();
      rqh.setReceiverKey(new URI("http://vidi"));

      // Test operation
      binding.completed(rqh, rqb,
            rsh, rsb);
      // TBD - validate results
   }
   ...
   public void test8asapObserverBindingStateChanged() throws Exception {
      ...
      _Request rqh = new _Request();
      _StateChangedRq rqb = new _StateChangedRq();
      _ResponseHolder rsh = new _ResponseHolder();
      ObjectHolder rsb = new javax.xml.rpc.holders.ObjectHolder();

      rqh.setReceiverKey(new URI("http://vidi"));
      // Test operation
      binding.stateChanged(rqh, rqb,
            rsh, rsb);
      // TBD - validate results
   }
*/
   public void test9asapFactoryBindingGetProperties() throws Exception {
      AsapFactoryBindingStub binding;
      String uriString;
      //uriString = "http://interop.i-flow.com/iflowjsp/jsp/ProcDef.jsp?planName=Manufacturer";
      uriString = "http://www.staffware.co.za:8080/ASAPServer/FactoryService.asmx";
      //uriString = "http://68.96.20.206:7787/asap_evm";;
      //uriString = "http://interop.i-flow.com/iflowjsp/jsp/ProcDef.jsp?planName=Retailer";

      try {
         binding = (AsapFactoryBindingStub) new SharkWebServiceLocator()
         //.getasapFactoryBinding(new URL());
         .getasapFactoryBinding(new URL(uriString));
         //
      } catch (javax.xml.rpc.ServiceException jre) {
         if (jre.getLinkedCause() != null)
            jre.getLinkedCause().printStackTrace();
      ...
      for (int n = 0; n < oo.length; ++n) {
         System.err.println(""+n+"#"+binding.getResponseHeaders()[n].toString());
      }
      // TBD - validate results
...
/*
   public void test10asapFactoryBindingCreateInstance() throws Exception {
      ...
      _Request rqHead = new _Request();
      _CreateInstanceRq rqBody = new _CreateInstanceRq();
      _ResponseHolder rsHead = new _ResponseHolder();
      _CreateInstanceRsHolder rsBody = new _CreateInstanceRsHolder();

      rqHead.setReceiverKey(new URI(new SharkWebServiceLocator()
   ...
   public void test11asapFactoryBindingListInstances() throws Exception {
      ...
      _Request rqh = new _Request();
      rqh.setReceiverKey(new URI(new SharkWebServiceLocator()
            .getasapFactoryBindingAddress()));
      ...
      _ListInstancesRq rqb = new _ListInstancesRq();
      _ResponseHolder rsh = new _ResponseHolder();
      _ListInstancesRsHolder rsb = new _ListInstancesRsHolder();
      // Test operation
      binding.listInstances(rqh, rqb, rsh, rsb);
      _Instance[] a = rsb.value.getInstance();
      if (null != a) {
   ...
   public void test2asapInstanceBindingSetProperties() throws Exception {
      ...
      try {
         binding = (AsapInstanceBindingStub) new SharkWebServiceLocator()
      ...
      _Request rqh = new _Request();
      _SetPropertiesRq rqb = new _SetPropertiesRq();
      _ResponseHolder rsh = new _ResponseHolder();
   ...
   public void test3asapInstanceBindingSubscribe() throws Exception {
      ...
      _Request rqh = new _Request();
      _SubscribeRq rqb = new _SubscribeRq();
      _ResponseHolder rsh = new _ResponseHolder();
      ObjectHolder rsb = new javax.xml.rpc.holders.ObjectHolder();
   ...
   public void test1asapInstanceBindingGetProperties() throws Exception {
      ...
      _Event[] _ev_ = ipg.getHistory().getEvent();
   ...
   public void test4asapInstanceBindingUnsubscribe() throws Exception {
      ...
      _Request rqh = new _Request();
      _UnsubscribeRq rqb = new _UnsubscribeRq();
      _ResponseHolder rsh = new _ResponseHolder();
      ObjectHolder rsb = new javax.xml.rpc.holders.ObjectHolder();
      rqh.setReceiverKey(ik);
      rqb.setObserverKey(new URI(new SharkWebServiceLocator()
   ...
   public void test5asapInstanceBindingChangeState() throws Exception {
      ...
      _Request rqh = new _Request();
      _ChangeStateRq rqb = new _ChangeStateRq();
      _ResponseHolder rsh = new _ResponseHolder();
      _ChangeStateRsHolder rsb = new _ChangeStateRsHolder();
      rqh.setReceiverKey(ik);
