...
public class ChangeStateRq  implements java.io.Serializable {
    private org.enhydra.shark.asap.types.StateType state;

    public ChangeStateRq() {
    }
    ...
    /**
     * Gets the state value for this ChangeStateRq.
     * 
     * @return state
     */
    ...
    /**
     * Sets the state value for this ChangeStateRq.
     * 
     * @param state
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeStateRq)) return false;
        ChangeStateRq other = (ChangeStateRq) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeStateRq.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.oasis-open.org/asap/0.9/asap.xsd", ">ChangeStateRq"));
